...
/**
 * A class that represents a HeavySkeletalSwordsman -> a type of enemy. Becomes Pile of Bones upon Death
 * @author Harshath Muruganantham
 * @see Skeleton
 * @see IRune
 * @see SpecialDeath
 */
public class HeavySkeletalSwordsman extends Skeleton implements IRune, SpecialDeath {
