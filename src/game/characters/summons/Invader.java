...
/**
 * An inveder Class (Spawned from summon Sign) that acts as an enemy.
 * @author Ziheng Liao
 * Modified By: Harshath Muruganantham
 * @see Actor
 * @see SpecialResettables
 */
public class Invader extends Actor implements SpecialResettables {
    ...
    public Invader(Archetype archetype) {
        ...
        super("Invader", 'ඞ', archetype.getHitPoints());
        ...
        RuneManager.getInstance().storeRuneAmount(this, RandomNumberGenerator.getRandomInt(1358, 5578));
        ...
        if (getBehaviour(998) == null) {
            ...
            Location destination = exit.getDestination();
                if (destination.containsAnActor()) {
                    if (!(destination.getActor().hasCapability(Status.INVADER))) {
            ...
            if (getWeaponInventory().get(0).hasCapability(Status.RANGE_ATTACK)) {
                ...
                for (Actor enemy : enemies) {
                    if (!(enemy.hasCapability(Status.INVADER))) {
...
//                    }
    ...
    /**
     * Returns the allowable actions of the invader.
     * @param otherActor: The other actor.
     * @param direction: The direction of the other actor.
     * @param map: The map of the game.
     * @return The allowable actions of the invader.
     */
    @Override
    public ActionList allowableActions(Actor otherActor, String direction, GameMap map) {
        ActionList actions = new ActionList();
        if(otherActor.hasCapability(Status.HOSTILE_TO_ENEMY)){
            if (!(otherActor.hasCapability(Status.INVADER))) {
    ...
    /**
     * Returns the behaviour of the invader based on priority.
     * @param priority: The priority of the behaviour.
     * @return The behaviour of the invader.
     */
    ...
    /**
     * Adds a behaviour to the invader.
     * @param priority: The priority of the behaviour.
    ...
    /**
     * Returns the behaviours of the invader
     * @return The behaviours of the invader.
     */
    ...
    /**
     * Sets the behaviours of the invader.
